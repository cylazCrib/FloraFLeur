...
<body class="text-white scroll-smooth">
    ...
    <div id="signin-modal" class="fixed inset-0 modal-overlay z-50 hidden items-center justify-center p-4">
         <div class="w-full max-w-md p-8 md:p-12 rounded-2xl form-container-bg relative animate-fade-in">
            ...
            <form class="mt-10 space-y-8" id="signin-form">
                <div class="relative">
                    <label for="signin-email" class="text-sm font-medium text-gray-200">Email</label>
                    <input id="signin-email" name="email" type="email" autocomplete="email" required class="w-full form-input-style" placeholder="">
                ...
                <div class="relative">
                    ...
                    <input id="signin-password" name="password" type="password" autocomplete="current-password" required class="w-full form-input-style" placeholder="">
                ...
                <div class="flex items-center justify-between text-sm">
                    ...
                    <a href="#" id="forgot-password" class="font-medium text-gray-300 hover:text-white transition">Forgot Password?</a>
                </div>

                <div class="flex items-center text-sm">
                    <input id="login-as-vendor" name="login-as-vendor" type="checkbox" class="h-4 w-4 rounded border-gray-300 bg-transparent">
    ...
    <div id="signup-modal" class="fixed inset-0 modal-overlay z-50 hidden items-center justify-center p-4">
         <div class="w-full max-w-md p-8 md:p-12 rounded-2xl form-container-bg relative animate-fade-in">
            ...
            <form class="mt-10 space-y-8" id="signup-form">
                <div class="relative">
                     <label for="signup-username" class="text-sm font-medium text-gray-200">Username</label>
                    <input id="signup-username" name="username" type="text" autocomplete="username" required class="w-full form-input-style" placeholder="">
                </div>
                 <div class="relative">
                    <label for="signup-email" class="text-sm font-medium text-gray-200">Email</label>
                    <input id="signup-email" name="email" type="email" autocomplete="email" required class="w-full form-input-style" placeholder="">
                    <i class="fa-regular fa-envelope absolute right-2 top-8 text-gray-400"></i>
                </div>
                <div class="relative">
                    <label for="signup-password" class="text-sm font-medium text-gray-200">Password</label>
                    <input id="signup-password" name="password" type="password" autocomplete="new-password" required class="w-full form-input-style" placeholder="">
                    <i class="fa-solid fa-lock absolute right-2 top-8 text-gray-400"></i>
                </div>
                <div>
                    <button type="submit" class="w-full flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-sm font-bold text-white btn-maroon hover:opacity-90 transition transform hover:scale-105">
    ...
    <div id="admin-login-modal" class="fixed inset-0 modal-overlay z-50 hidden items-center justify-center p-4">
         <div class="w-full max-w-md p-8 md:p-12 rounded-2xl form-container-bg relative animate-fade-in">
            ...
            <form class="mt-10 space-y-8" id="admin-login-form">
                <div class="relative">
                    <label for="admin-email" class="text-sm font-medium text-gray-200">Admin Email</label>
                    <input id="admin-email" name="email" type="email" autocomplete="email" required class="w-full form-input-style" placeholder="">
                    <i class="fa-regular fa-envelope absolute right-2 top-8 text-gray-400"></i>
                </div>
                <div class="relative">
                    <label for="admin-password" class="text-sm font-medium text-gray-200">Password</label>
                    <input id="admin-password" name="password" type="password" autocomplete="current-password" required class="w-full form-input-style" placeholder="">
                    <i class="fa-solid fa-lock absolute right-2 top-8 text-gray-400"></i>
                </div>
                <div>
                    <button type="submit" class="w-full flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-sm font-bold text-white btn-maroon hover:opacity-90 transition transform hover:scale-105">
    ...
    <div id="signup-store-modal" class="fixed inset-0 modal-overlay z-50 hidden items-center justify-center p-4">
        <div class="w-full max-w-2xl max-h-[90vh] overflow-y-auto p-8 md:p-12 rounded-2xl form-container-bg relative text-white animate-fade-in">
            ...
            <form id="store-signup-form" class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                <div class="space-y-6">
                    <div>
                        ...
                        <div class="space-y-4">
                            <div class="relative">
                                ...
                                <input type="text" class="w-full form-input-style" placeholder="Full name">
                            </div>
                            <div class="relative">
                                <label class="text-sm font-medium text-gray-200">Age</label>
                                <input type="text" class="w-full form-input-style" placeholder="Your age">
                            </div>
                            <div class="relative">
                                <label class="text-sm font-medium text-gray-200">Email</label>
                                <input type="email" class="w-full form-input-style" placeholder="Email address">
                            </div>
                            <div class="relative">
                                <label class="text-sm font-medium text-gray-200">Phone Number</label>
                                <input type="tel" class="w-full form-input-style" placeholder="Phone number">
                            </div>
                        </div>
                    </div>
                     <div>
                        ...
                        <div class="space-y-4">
                            <div class="relative">
                                ...
                                <input type="text" class="w-full form-input-style" placeholder="Your shop name">
                            </div>
                            <div class="relative">
                                <label class="text-sm font-medium text-gray-200">Shop Description</label>
                                <textarea class="w-full form-input-style h-24" placeholder="Describe your shop"></textarea>
                            </div>
                            <div class="relative">
                                <label class="text-sm font-medium text-gray-200">Shop Phone/Tel. Number</label>
                                <input type="tel" class="w-full form-input-style" placeholder="Shop contact number">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            <div class="relative">
                                ...
                                <input type="text" class="w-full form-input-style" placeholder="Street address">
                            </div>
                            <div class="relative">
                                <label class="text-sm font-medium text-gray-200">Zip Code</label>
                                <input type="text" class="w-full form-input-style" placeholder="Zip code">
                            </div>
                            <div class="relative">
                                <label class="text-sm font-medium text-gray-200">Delivery Coverage Area</label>
                                <input type="text" class="w-full form-input-style" placeholder="Areas you deliver to">
                            </div>
                        </div>
                    </div>
                     <div>
                        ...
                        <div class="relative">
                             <label for="file-upload" class="form-input-style w-full flex items-center justify-between cursor-pointer text-gray-300 py-3 px-0 border-b border-gray-400">
                                <span id="file-label-text">DTI/Business Permit</span>
