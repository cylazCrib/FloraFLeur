        ...
        <aside class="sidebar">
            ...
            <nav class="navigation">
                <ul>
                    ...
                    <li><a class="nav-item" data-target="registrations-view"><i class="fa-solid fa-file-signature"></i> Manage Registrations</a></li>
                    <li><a class="nav-item" data-target="vendors-view"><i class="fa-solid fa-store"></i> Manage Shop/Vendors</a></li>
